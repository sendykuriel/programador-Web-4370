$('document').ready(function () {
  ...
  let campoNombre = $('#firstName')
  let mail = $('#email')
  let campoComent = $('#comments')
  let submitButton = $('#submitButton')

  // Eventos 

  campoComent.one('blur', validateNonEmpty)
  mail.one('blur', validateEmail)
  campoNombre.one('blur', validateNonEmpty)
